 ...
 */
@AllArgsConstructor
public class VertxCoapClient implements CoapClient {
    ...
    public VertxCoapClient(org.eclipse.californium.core.CoapClient coapClient, CoapClientProperties properties) {
    ...
    public Mono<CoapResponse> publish(Request request) {
        ...
        if (request.getReliabilityLayerParameters() == null) {
            request.setReliabilityLayerParameters(ReliabilityLayerParameters
                                                      .builder()
                                                      .applyConfig(Configuration.getStandard())
