...
public abstract class AbstractSession implements Session {
    ...
    private final List<Runnable> connectBeforeListener = new CopyOnWriteArrayList<>();
    ...
    @Override
    public Disposable onConnectBefore(Runnable callback) {
        connectBeforeListener.add(callback);
    ...
    public final Mono<Void> connect() {
        ...
        createTime = connectTime = System.currentTimeMillis();
        connectBeforeListener.forEach(Runnable::run);
        return doConnect()
