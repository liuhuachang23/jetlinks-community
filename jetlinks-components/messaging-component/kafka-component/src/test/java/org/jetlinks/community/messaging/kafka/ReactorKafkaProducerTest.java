...
class ReactorKafkaProducerTest {
    ...
    void testSend() {
        ...
        ReactorKafkaProducer producer = new ReactorKafkaProducer(properties, sslBundles);
        ReactorKafkaConsumer consumer = new ReactorKafkaConsumer(Collections.singleton("test"), properties,null);
