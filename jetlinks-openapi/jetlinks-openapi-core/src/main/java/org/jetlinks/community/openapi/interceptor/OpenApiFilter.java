            ...
            return clientManager
                    ...
                    .flatMap(client -> {
                        ...
                        return checker
                                ...
                                .contextWrite(ctx -> ctx.put(OpenApiClient.class, client))  // 替换 subscriberContext
                                .contextWrite(ContextUtils.acceptContext(innerCtx ->  // 替换 subscriberContext
                                        innerCtx.put(ContextKey.of(Authentication.class), client.getAuthentication())
                                ))
                    ...
                    .contextWrite(ReactiveLogger.start("openApiClientId", clientId));  // 替换 subscriberContext
        }
